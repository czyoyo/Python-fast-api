...
from app.crud.user import get_user_by_email, get_user_by_nickname, \
  create_user, authenticate, is_active, is_superuser
...
def register(
  ...
  if get_user_by_nickname(db, nickname=user_in.nickname):
    raise HTTPException(
        status_code=400,
